...
const Layout = ({children}: PropsWithChildren) => {
  ...
  return (
    <div className="min-h-screen flex flex-row flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800">
      <div className="fixed flex flex-col top-0 left-0 w-72 bg-white h-screen border-r">
            ...
            <li>
              ...
              >
                ...
                <span className="ml-2 text-sm tracking-wide truncate">
                 We need to  filter customers by events, eg. customers that made a purchase 6 months ago
      ...
      <div className="min-w-0 max-w-2xl flex-auto px-4 py-16 lg:max-w-none lg:pl-8 lg:pr-0 xl:px-16">{children}</div>
    </div>
  );
};
